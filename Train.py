...
## Argument for choosing the value of lambda.
parser.add_argument('--lambdaV', type = str, default = 'anneal', help = 'Define the value of lambda to be chosen.')
...
if __name__ == '__main__':
	...
	for epoch in range(0, argList.numEpochs):
		...
		if (argList.lambdaV == 'anneal'):

			## Annealing unlabeled loss.
			if epoch < 5:
				lambdaVal = 0.0
			elif (epoch >= 5 and epoch < 40):
				lambdaVal = (epoch - 5) * 1.0 / (40 - 5)
			else:
				lambdaVal = 1.0	

		else if (argList.lambdaV == '1'):
			lambdaVal = 1.0

		else if (argList.lambdaV == '0'):
			lambdaVal = 0.0
	...
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/clusterCenters', dataCenters, allow_pickle = True)

	## Saving the different tracking lists.
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/KLLossListλAnneal', KLLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/totalLossListλAnneal', totalLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/reconErrorListλAnneal', reconErrorList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/clusterLossListλAnneal', clusterLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/labelledLossListλAnneal', labelledLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/unLabelledLossListλAnneal', unLabelledLossList)

	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/trainNMILabelledListλAnneal', trainNMILabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/trainNMIUnlabelledListλAnneal', trainNMIUnlabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/trainNMIUnlabelledListλAnneal', trainPurityLabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λAnnealResults/trainPurityUnlabelledListλAnneal', trainPurityUnlabelledList)