...
if __name__ == '__main__':
	...
	plt.savefig('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage' + str(int(argList.percentLabData * 100)) +'/λ1.0Results/TotalLossλ10.png')

	## Saving the pretrained model.
	torch.save(Model, './TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/AutoEncoderλ10.pkl')
	torch.save(Model.state_dict(), './TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/AutoEncoderλ10.pth')

	## Saving the cluster centers.
	dataCenters = clusterCenters.data.cpu().numpy()
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/clusterCenters', dataCenters, allow_pickle = True)

	## Saving the different tracking lists.
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/KLLossListλ10', KLLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/totalLossListλ10', totalLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/reconErrorListλ10', reconErrorList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/clusterLossListλ10', clusterLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/labelledLossListλ10', labelledLossList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/unLabelledLossListλ10', unLabelledLossList)

	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/trainNMILabelledListλ10', trainNMILabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/trainNMIUnlabelledListλ10', trainNMIUnlabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/trainNMIUnlabelledListλ10', trainPurityLabelledList)
	np.save('./TrainingResults/' + str(argList.dataSet) + '/NoPreTraining/Percentage'+ str(int(argList.percentLabData * 100)) + '/λ1.0Results/trainPurityUnlabelledListλ10', trainPurityUnlabelledList)